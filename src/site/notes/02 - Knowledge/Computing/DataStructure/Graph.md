---
{"dg-publish":true,"permalink":"/02 - Knowledge/Computing/DataStructure/Graph/","tags":["type/study","context/studies","theme/data-structure","status/completed"]}
---
...
### 부분 그래프
- 원래 그래프에서 **일부의 정점이나 간선을 제외**한 그래프

### 트리도 그래프이다
- 각 노드는 최대 하나의 부모 노드가 존재할 수 있다
- 각 노드는 자식 노드가 없거나 하나 이상이 존재할 수 있다
- 두 노드 사이에는 **유일한 경로**가 존재한다
