---
{"dg-publish":true,"permalink":"/04 - Knowledge/AI/Agent/Agent Architecture/","tags":["domain/ai"]}
---
...
> - **도구 (Tools)**: 에이전트가 외부 세계와 상호작용하는 수단 → [[Agent Tools\|Agent Tools]] 참고
...
[[_Agent\|_Agent]] | [[AI Agent\|AI Agent]] | [[Agent Tools\|Agent Tools]]
