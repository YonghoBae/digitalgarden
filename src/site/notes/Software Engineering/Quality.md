...
- 밀접한 관련이 있음: 프로세스를 사용하여 소프트웨어 제품을 만듦
    - **제품 품질**:
        - 기능성
        - 사용성
        - 효율성
...
- 소프트웨어 시스템이 결함을 한정된 작업량으로 수정할 수 있으면 수정 가능하다고 함
- 올바른 모듈화가 이루어져야 수정 가능성이 향상됨

---

### 진화성

- 소프트웨어는 시간이 지남에 따라 새로운 기능을 제공하거나 기존 기능을 변경하도록 수정됨
- 규모가 크고 복잡한 소프트웨어에서 중요함
- 모듈화를 통해 달성됨
- 새로운 버전이 릴리스될 때마다 진화성이 감소함
...
- 예시: 과학 라이브러리, MFC, Eclipse 플러그인 등
