---
{"dg-publish":true,"permalink":"/Archive/CBNU/3-2/Software Engineering/Quality/"}
---
...
- **객체지향** 구조를 이해하면 편함
- **추상화**와 **모듈방식**에 따라 강화
- [[Archive/CBNU/3-2/Software Engineering/Quality#Maintainability(수정 가능성)\|Maintainability]]과의 관계는
	- **비례관계**
