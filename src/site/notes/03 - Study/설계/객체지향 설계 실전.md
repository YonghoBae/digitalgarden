---
{"dg-publish":true,"permalink":"/03 - Study/설계/객체지향 설계 실전/","tags":["domain/backend"]}
---
...
## 관련 개념
- [[소프트웨어 설계\|소프트웨어 설계]] - 응집도/결합도
- [[GOF 패턴\|GOF 패턴]] - Strategy, Template Method
- [[03 - Study/설계/레이어드 아키텍처\|레이어드 아키텍처]] - 레이어 책임 분리
