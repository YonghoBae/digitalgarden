---
{"dg-publish":true,"permalink":"/03 - Study/설계/도메인 모델 설계/","tags":["domain/backend"]}
---
...
## 관련 개념
- [[03 - Study/설계/객체지향 설계 실전\|객체지향 설계 실전]] - 일급 컬렉션, 예외 계층
- [[03 - Study/설계/레이어드 아키텍처\|레이어드 아키텍처]] - Controller/Service 역할
- [[UML\|UML]] - 클래스 다이어그램 표기법
